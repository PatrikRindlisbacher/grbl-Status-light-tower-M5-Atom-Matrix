...
void light_tower_status_update(){
  if (Maschine_State.State_current== State::Idle){                          // Idle = green on
    light_tower_Status.red_lamp=GPIO_Output_Conditions::off;                // red 
    light_tower_Status.orange_lamp=GPIO_Output_Conditions::off;             // orange
    light_tower_Status.green_lamp=GPIO_Output_Conditions::on;               // green
  }
  else if (Maschine_State.State_current== State::Alarm){                    // Alarm = red flashing
    light_tower_Status.red_lamp=GPIO_Output_Conditions::flashing;           // red 
    light_tower_Status.orange_lamp=GPIO_Output_Conditions::off;             // orange
    light_tower_Status.green_lamp=GPIO_Output_Conditions::off;              // green
  }
  else if (Maschine_State.State_current== State::CheckMode){                // Checkmode = red blinking
    light_tower_Status.red_lamp=GPIO_Output_Conditions::blinking;           // red 
    light_tower_Status.orange_lamp=GPIO_Output_Conditions::off;             // orange
    light_tower_Status.green_lamp=GPIO_Output_Conditions::off;    
  }
  else if (Maschine_State.State_current== State::Run){                      // Run = orange on
    light_tower_Status.red_lamp=GPIO_Output_Conditions::off;                // red 
    light_tower_Status.orange_lamp=GPIO_Output_Conditions::on;              // orange
    light_tower_Status.green_lamp=GPIO_Output_Conditions::off;              // green
  }
    ...
    light_tower_Status.red_lamp=GPIO_Output_Conditions::off;                // red 
    light_tower_Status.orange_lamp=GPIO_Output_Conditions::blinking;        // orange
    light_tower_Status.green_lamp=GPIO_Output_Conditions::off;              // green
  }
